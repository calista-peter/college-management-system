...
import com.Collage.service.ThirdService.VO.Grades;
...
//    }
    ...
    public ResponseTemplateVO getCourseById(Long studentId) {
        ...
        ResponseTemplateVO vo1 = new ResponseTemplateVO();
        Student student = studentRepository.findByStudentId(studentId);
        Object object = student.getStudentId();

        Grades grades = restTemplate.getForObject("http://localhost:5454/student_grade/"+ object,
                Grades.class);

        Course course = restTemplate.getForObject("http://localhost:9099/courses/"+ object,
                Course.class);

        vo1.setStudent(student);
        vo1.setGrades(grades);
